...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Kervin", "Moya", "kermoya39@gmail.com", "350 634 2747", "Calle Luna Calle Sol Sur", "Manager");
            var owner = await CheckUserAsync("2020", "Keylor", "Salazar", "ker_sal@hotmail.com", "350 634 2747", "Calle San Juan Oeste", "Owner");
            var lessee = await CheckUserAsync("3030", "Mainor", "Hidalgo", "cafe24hidalgo@gmail.com", "350 634 2747", "Calle San Luis Este", "Lessee");
